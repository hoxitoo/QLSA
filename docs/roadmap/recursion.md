...
**Актуальная картина.** При q=1 (демо-конфиг, 16 бит) рекурсия всё ещё в ~1.5 раза дороже прямой
проверки — за неё нет смысла платить. При боевой стойкости прямая проверка невозможна
(q=20 → ~40M на группу), а рекурсия экстраполируется в ~7.5M на группу. **Рекурсия — это механизм
для БОЕВОЙ стойкости, а не для экономии газа на демо-конфиге.**

Стек v8 имеет смысл строить вместе с переходом на большое `n_queries`; на q=1 он строго хуже v7.
