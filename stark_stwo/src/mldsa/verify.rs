...
mod tests {
    ...
    #[test]
    fn test_verify_liboqs_vector() {
        // Test vectors generated by Python liboqs ML-DSA-65 (FIPS 204 external API).
        let pk  = include_bytes!("../../tests/fixtures/mldsa65_pk.bin");
        let sig = include_bytes!("../../tests/fixtures/mldsa65_sig.bin");
        let msg = include_bytes!("../../tests/fixtures/mldsa65_msg.bin");
        assert!(ml_dsa_verify(pk, msg, sig), "failed to verify liboqs-generated signature");
    }

    #[test]
    fn test_verify_liboqs_vector_wrong_message() {
        let pk  = include_bytes!("../../tests/fixtures/mldsa65_pk.bin");
        let sig = include_bytes!("../../tests/fixtures/mldsa65_sig.bin");
        assert!(!ml_dsa_verify(pk, b"wrong message", sig), "should reject wrong message");
    }
