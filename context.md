...
**Актуальный вывод:** при q=1 рекурсия в ~1.5 раза дороже прямой проверки; при боевой стойкости
(q=20) прямая проверка невозможна (~40M на группу), рекурсия экстраполируется в ~7.5M. Рекурсия —
механизм для БОЕВОЙ стойкости, а не экономия газа на демо-конфиге. Стек v8 имеет смысл строить
вместе с переходом на большое `n_queries`.
