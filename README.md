...
| **MVP-7 testnet tooling (t=8 stack)** — `deploy_v7.js`/`deploy_v7.sh` (VFRI11 + BatchRegistryV5), `OnchainSubmitterV5` single atomic `submitBatchWithNonces`, `e2e.py --stack v7`. Node collision ~2^62 (vs t=4's ~2^31) in ONE transaction at ~6.06M gas | ✅ Done (2026-07-30) |
