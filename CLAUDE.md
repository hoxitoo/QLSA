...
- **Ladder:** t=2 (2^31) → t=4 (VFRI10, 2-word nodes, 2^31) → **t=8 (this, 4-word nodes, 2^62)**
  → t=16 (8-word nodes, ~2^124 ≈ 128-bit — matches Stwo's native Poseidon2-16). Not yet wired into
  a verifier (groundwork, same staging as t=4 began).
